...
public class BinarySearchTree<E extends Comparable<E>> {
	 ...
	 * 
	 * @return the greatest value in the tree (the farthest right)
	 */
	public E findMax() {
		E max = null;
		Node n = root;
	...
	/**
	 * Removes the lowest value in the tree and eliminates the carrying node.
	 * 
	 * @return the data value of the removed lowest node, null if the tree is empty
	 */
	public E removeMin() {
		...
		// Remove left-most node. Ensure we retain possible right sub-trees
		E removed = n.data;
		prev.left = n.right;
		return removed;
	}
