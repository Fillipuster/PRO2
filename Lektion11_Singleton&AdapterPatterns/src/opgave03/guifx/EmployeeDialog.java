...
import opgave03.service.Service;
...
public class EmployeeDialog extends Stage
{
    ...
    private void initContent(GridPane pane)
    {
        ...
        cbbCompany.getItems().addAll(Storage.getInstance().getCompanies());
    ...
    private void okAction()
    {
        ...
        if (employee != null) {
            ...
            if (companyIsSelected) {
                Service.getInstance().updateCompanyOfEmployee(employee, newCompany);
            }
            else {
                Service.getInstance().clearCompanyOfEmployee(employee);
            }
        }
        else {
